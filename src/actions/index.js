...
export const fetchRecipe = foodItem => {
  ...
  const request = axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY}&number=12&query=${foodItem}&addRecipeInformation=true&instructionsRequired=true`)
    .catch(error => {
